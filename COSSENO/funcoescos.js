...
document.getElementById("ecos").innerHTML = cos; //mostrando o cos em html
...
erro=(cos-m)
document.getElementById("derro").innerHTML = erro; //mostra o erro com 1 algarismo significativo
}
